...
\usepackage{physics}    % wes 1/2024
\usepackage{amssymb}    % wes 1/2024
\usepackage{amsmath}    % wes 1/2024
...
\author{Your Name Here\thanks{email:youremail@sfsu.edu}\\ %
        \scriptsize SFSU %
% if there's just one author, you can remove the next two
\and Ed Grimley\thanks{e-mail:ed.grimley@aol.com}\\ %
